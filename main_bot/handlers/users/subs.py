...
def register_subscribe_handlers(dispatcher: Dispatcher):
    dispatcher.register_message_handler(subscribe, IsPrivate(), IsNotSubscribed(), commands=["subscribe"],
                                        commands_prefix="!/", state="*")
    dispatcher.register_message_handler(unsubscribe, IsPrivate(), IsSubscribed(), commands=["unsubscribe"],
                                        commands_prefix="!/", state="*")
